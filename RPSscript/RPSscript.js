function playRound(playerSelection, computerSelection) { // Convert both selections to lowercase for case-insensitive comparison
...
function getComputerChoice() { // Generate a random number between 0 and 2
